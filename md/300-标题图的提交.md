...
最后一提，对于个人博客来说，**服务器的存储空间、带宽都是宝贵的资源**。多媒体文件通常应该放到专业的对象存储云服务商中，最好不要老老实实上传到自己服务器。这又牵扯到另外一个问题，就是和对象存储云服务商的接口对接，不过这又是另外一个话题了。

> 或者就老老实实手动上传吧，对产量小的博客来说也没那么麻烦。
